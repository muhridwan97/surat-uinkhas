...
if ($cek_ns->num_rows() == 0) {
  $no_surat       = "B-2489/In.20";
}else{
  $noUrut         = substr($cek_ns->row()->no_surat, 2, 4);
  //$noUrut=2489;
  $noUrut++;
  $kode="/In.20";
        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-folder-upload2"></i> Tambah Surat Masuk Baru</legend>
                <?php
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-5">
                        <div class="input-group">
                          ...
                          <input type="text" name="ns" id="ns" class="form-control" placeholder=""  required>
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="input-group">
