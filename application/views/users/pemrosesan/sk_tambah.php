                ...
                <form class="form-horizontal" action="users/sk"  enctype="multipart/form-data" method="post">
                    <div class="form-group">
                      ...
                      <div class="col-lg-5">
                        <div class="input-group">
                          ...
                          <input type="hidden" name="nsx" id="nsx" class="form-control" placeholder="" value="<?php echo $no_surat; ?>" required >
                          <input type="text" name="ns" id="ns" class="form-control" placeholder="" value="<?php echo $no_surat ."/../" .date('m/Y') ; ?>" required>
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="input-group">
                    ...
                    <div class="col-lg-9">
                      <select class="form-control" name="pimpinan" id="pimpinan"
                              data-placeholder="pimpinan" style="width: 100%" required>
                          <?php foreach ($pimpinan as $key => $pimp) : ?>
                          <option value="<?= $pimp['id'] ?>" <?= set_select('pimpinan', $pimp['pimpinan'], (isset($_GET['pimpinan']) ? $_GET['pimpinan'] : '') == $pimp['pimpinan']) ?>><?= $pimp['pimpinan'] ?></option>                          
                          <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
  ...
  init: function() {
    ...
    this.on("sending", function(data, xhr, formData) {
            ...
            formData.append("departemen", jQuery("#departemen").val());
             formData.append("pimpinan", jQuery("#pimpinan").val());
    });
